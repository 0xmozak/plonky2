...
pub trait Stark<F: RichField + Extendable<D>, const D: usize>: Sync {
    ...
    fn eval_packed_generic<FE, P, const D2: usize>(
        &self,
        vars: &StarkEvaluationVars<FE, P, { Self::PUBLIC_INPUTS }>,
    ...
    fn eval_packed_base<P: PackedField<Scalar = F>>(
        &self,
        vars: StarkEvaluationVars<F, P, { Self::PUBLIC_INPUTS }>,
        yield_constr: &mut ConstraintConsumer<P>,
    ) {
    ...
    fn eval_ext(
        &self,
        vars: &StarkEvaluationVars<F::Extension, F::Extension, { Self::PUBLIC_INPUTS }>,
